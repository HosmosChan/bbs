...
public class SelectMessageController {
    ...
    @RequestMapping(value = "/selectMessage")
    public ModelAndView getMessageList(String recievePersonAccount, HttpServletRequest request, Integer messageStatus) {
        ...
        List<PrivateMessageVo> privateMessage = selectMessageService.getMessageList(recievePersonAccount, messageStatus);
