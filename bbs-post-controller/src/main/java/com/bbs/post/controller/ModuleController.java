...
public class ModuleController {
    ...
    @RequestMapping(value = "/addnewPostClassController")
    ...
    public String insertPostClasss(HttpServletRequest request, PostClass postClass, HttpSession session) throws BusinessRunException {
        User1 user = new User1();
        user = (User1) session.getAttribute("user1");
        postClass.setCreateBy(user.getUserName());
