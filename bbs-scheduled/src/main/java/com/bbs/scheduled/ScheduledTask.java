...
public class ScheduledTask {
    ...
    public void AutoCreateNewData() throws ParseException{
    ...
    public void autoupdateWeekData() throws ParseException{
    ...
    public void autoupdateMonthData() throws ParseException{
		...
		String month=String.valueOf(c.get(Calendar.MONTH));
		 ...
		 {
			 //
			 roleserviceImpl.checkLastWeekActivityUser();
		 }
		 //统计上个月的信息 
